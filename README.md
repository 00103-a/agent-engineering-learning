...
- [当前两周学习计划](./01-两周学习计划.md)：Python-for-Agent 每日任务、提示等级和阶段验收
- [下一课学习上下文](./02-下一课学习上下文.md)：当前掌握状态、教学边界和下一次课程入口
...
课前诊断已经完成，当前进入 Python-for-Agent 两周基础阶段：
...
- [2026-07-15 至 2026-07-28 学习计划](./01-两周学习计划.md)
